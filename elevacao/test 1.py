...
def toggle_modal(active_cell, is_open, table_data, data_store):
    ...
    if active_cell and active_cell['column_id'] == 'NAME' :
        ...
        df_tb2_ = df_tb2[df_tb2['DOCUMENTOS'] != ['BRAZILIAN NATIONAL DOCUMENT', 'PILOT LICENSE']]
  ...
  #==========================================> CONFIGURAÇÃO DOS GRAFICOS LINHA 3
        ...
        tab1_content = html.Div([
            ...
            dbc.Col([            
                ...
                html.P([dbc.Card([html.Strong('Gênero: ')],style=style_font), f'{gend_value}'],style=style_profile),
