...
style_font={'color':'rgb(26, 61, 114)' ,'text-align':'center','font-size':'14px'}
...
def toggle_modal(active_cell, is_open, table_data, data_store):
  ...
  #==========================================> CONFIGURAÇÃO DOS GRAFICOS LINHA 2
        ...
        fig_line_cop.update_layout(margin=dict(t=20, b=5, l=5, r=5),
                    ...
                    yaxis_showticklabels=False,  # Ocultar rótulos do eixo y
                    yaxis=dict(
                    range=[df_graph4_['MEDIA_TOTAL'].min()-0.2, df_graph4_['MEDIA_TOTAL'].max()+0.2], 
                            ),
                            width=1000,  # Largura do gráfico
                            height=200,
                            font=dict(
  ...
  #==========================================> CONFIGURAÇÃO DOS GRAFICOS LINHA 3
        ...
        fig_line = px.line(df_graph5_, x="ANO_ALUNO", y="MEDIA_TOTAL",text="MEDIA_TOTAL",title="MÉDIA SESSÕES GRUPO COPILOTOS")
        ...
        tab1_content = html.Div([
            ...
            dbc.Col([            
             ...
             width=4, style=style_box), 
            dbc.Col([            
                html.P([dbc.Card([html.Strong('Nível de Ingês: ')],style=style_font), f'{english_n}'],style=style_profile),
                ...
                html.P([dbc.Card([html.Strong('Horas de Voo Azul: ')],style=style_font), f'{vazio}'],style=style_profile),
                ],
             width=4, style=style_box),
                    ]),
